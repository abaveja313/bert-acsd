...
def experiment(
    ...
    examples = absa.load_category_examples()
...
if __name__ == '__main__':
    ...
    study = optuna.create_study(
        study_name=f'classifier-bert-acsd',
        direction='maximize',
        storage='sqlite:///optimization.db',
        load_if_exists=True)
    domain_objective = partial(objective, domain='restauarant')
    study.optimize(domain_objective, n_trials=30)
